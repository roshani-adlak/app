...
export default function EditSingle({ params }) {
  ...
  const [Editinsearch, setEditinsearch] = useState('');
      ...
      <div className='ap-search-wrap'>
        <form className='ap-search-form' method=''>
          <div className="ap-search-text">
            <input type='text' className='form-control' value={Editinsearch} onChange={(e) => setEditinsearch(e.target.value)} placeholder="Search Apps ...." />
