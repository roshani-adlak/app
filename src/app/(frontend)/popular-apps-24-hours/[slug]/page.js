...
export default function EditSingle({ params }) {
  ...
  const [popappsearch, setpopappssearch] = useState('');
      ...
      <div className='ap-search-wrap'>
        <form className='ap-search-form' method=''>
          <div className="ap-search-text">
            <input type='text' className='form-control' value={popappsearch} onChange={(e) => setpopappssearch(e.target.value)} placeholder="Search Apps ...." />
