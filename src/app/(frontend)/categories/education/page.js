...
export default function Educationsindata() {
    ...
    useEffect(() => {
        document.title = "Education > App Portal";
        setIsloading(true);
        setHaserror(false);
            ...
            <div className="ap-search-wrap">
                <form className="ap-search-form" method="">
                    <div className="ap-search-text">
                        <input type="text" className="form-control" value={educationsearch} onChange={(e) => setEducationsearch(e.target.value)} placeholder="Search Apps..." />
            ...
            <div className="ap-bg-cover ap-feat-app">
                ...
                {Array.isArray(educationdata) && educationdata.length === 0 ? (
                            ...
                            educationdata.map((item) => {
                                <div className="ap-display-box ap-lateapp-data ap-education-data" key={item.id}>
                                    <Link href="/">
