...
export default function CommSingle({ params }) {
  const { slug } = params;
  const [Item, setItem] = useState(null);
  const [error, setError] = useState(null);
  const [Comminsearch, setCommsinsearch] = useState('');
      ...
      <div className='ap-search-wrap'>
        <form className='ap-search-form' method=''>
          <div className="ap-search-text">
            <input type='text' className='form-control' value={Comminsearch} onChange={(e) => setCommsinsearch(e.target.value)} placeholder="Search Apps ...." />
