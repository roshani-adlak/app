...
export default function GameSingle({ params }) {
  const { slug } = params;
  const [Item, setItem] = useState(null);
  const [error, setError] = useState(null);
  const [Gamesinsearch, setGamesinsearch] = useState('');
      ...
      <div className='ap-search-wrap'>
        <form className='ap-search-form' method=''>
          <div className="ap-search-text">
            <input type='text' className='form-control' value={Gamesinsearch} onChange={(e) => setGamesinsearch(e.target.value)} placeholder="Search Apps ...." />
