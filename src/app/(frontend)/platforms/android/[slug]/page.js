...
export default function PlatformSingle({ params }) {
  const { slug } = params;
  const [Item, setItem] = useState(null);
  const [error, setError] = useState(null);
  const [Platinsearch, setPlatinsearch] = useState('');
      ...
      <div className='ap-search-wrap'>
        <form className='ap-search-form' method=''>
          <div className="ap-search-text">
            <input type='text' className='form-control' value={Platinsearch} onChange={(e) => setPlatinsearch(e.target.value)} placeholder="Search Apps ...." />
