...
export default function EditSingle({ params }) {
  ...
  const [popappsearch, setEditpopappsearch] = useState('');
      ...
      <div className='ap-search-wrap'>
        <form className='ap-search-form' method=''>
          <div className="ap-search-text">
            <input type='text' className='form-control' value={popappsearch} onChange={(e) => setEditpopappsearch(e.target.value)} placeholder="Search Apps ...." />
          ...
          {Item.slide.map((imageSrc, index) => (
            <SwiperSlide key={index}>
              <div className='ap-innerslide-content'>
                <Image src={imageSrc} alt={`slider-img-${index}`} />
              </div>
            </SwiperSlide>
          ))}
        </Swiper>
